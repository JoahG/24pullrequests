...
(function() {
  jQuery(function() {
    ...
    return $("#presents a").click(function(e) {
      e.preventDefault();
...
(function() {
  $(function() {
    $("#spinner").hide();
    return $('a#fetch-pull-requests').click(function(event) {
      event.preventDefault();
      $("#spinner, #search_button").toggle();
      return $.ajax('/pull_request_download', {
        dataType: 'html',
        type: 'post',
        success: function(data) {
          $('#pull-requests').html(data);
          return $("#spinner, #search_button").toggle();
        }
      });
    });
  });
...
(function() {
  ...
  $(function() {
    var fetchProjects, filterProjects, languages, projects, resetLanguage;
    projects = $('#projects').clone();
    $('#noprojects').hide();
    languages = [];
    $('#languages a').click(function(e) {
      var clicked_language, language;
      clicked_language = $(this).data().language;
      if (clicked_language == null) {
        fetchProjects();
        resetLanguage();
        return false;
      }
      if (!(e.ctrlKey || e.metaKey)) {
        ...
        if (__indexOf.call(languages, clicked_language) < 0) {
      ...
      if (!(languages.length > 0)) {
        ...
        $('#languages li').addClass('disabled').find($.map(languages, function(l) {
          return "a[data-language='" + l + "']";
        }).join(',')).parent('li').removeClass('disabled');
...
(function() {
  $(function() {
    ...
    return $('#coderwall-content').codersWall({
      team: [user_name],
      badge_size: 72
    });
  });
